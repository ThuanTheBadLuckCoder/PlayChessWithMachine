...
import src.com.chess.engine.classic.board.MoveUtils;
...
public final class Queen extends Piece {
    ...
    private final static int[] CANDIDATE_MOVE_COORDINATES = { -9, -8, -7, -1, 1,
            7, 8, 9 }; /*array represents the possible move offsets for the queen. The queen can move diagonally, horizontally, and vertically */
    ...
    private static Map<Integer, MoveUtils.Line[]> computeCandidates() {/*iterating over each tile on the board and calculating the valid move lines for the queen from that tile. 
        The method takes into account edge cases such as first column and eighth column exclusions */
