...
import src.com.chess.engine.classic.player.BlackPlayer;
import src.com.chess.engine.classic.player.Player;
import src.com.chess.engine.classic.player.WhitePlayer;
...
public final class Board {
    ...
    private static String prettyPrint(final Piece piece) {/*method converts a Piece object into a string representation.
        If the piece is not null, it returns a lowercase string representation for black pieces and the regular string representation for white pieces. If the piece is null, it returns a hyphen ("-").
    */
        if(piece != null) {
    ...
    public Collection<Move> getAllLegalMoves() { /* returns a collection of all legal moves for both players on the board */
    ...
    public Pawn getEnPassantPawn() { /*method returns the en passant pawn on the board, if any */
        return this.enPassantPawn;
    }

    public Move getTransitionMove() {/*method returns the transition move on the board*/
        return this.transitionMove;
    }

    public static Board createStandardBoard() {/*method, which sets up the initial position of all pieces*/
        return STANDARD_BOARD;
    }

    private static Board createStandardBoardImpl() {/*method, which sets up the initial position of all pieces*/
    ...
    private Collection<Move> calculateLegalMoves(final Collection<Piece> pieces) {/*method calculates and returns a collection of legal moves for the given collection of pieces on the board*/
    ...
    private static Collection<Piece> calculateActivePieces(final Builder builder,
                                                           final Alliance alliance) {/*method filters the pieces in the board configuration based on the specified alliance (black or white) and returns the active pieces of that alliance.*/
